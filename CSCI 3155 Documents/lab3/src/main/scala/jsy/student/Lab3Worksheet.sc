...
parse("function (y) {return 1}")

evaluate(parse("const x = 2; const g = (y) => x+x; const h = (x) => g(2); console.log(h(3))"))
iterateStep(parse("const x = 2; const g = (y) => x+x; const h = (x) => g(2); h(3)"))